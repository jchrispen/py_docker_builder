...
class TestDockerContainerManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        mock_config.get_config_value.side_effect = lambda key: {'log_file_path': '/path/to/log', 'container_name': 'test_container'}.get(key)
    ...
    def test_create_container_success(self, mock_run_command):
        ...
        mock_run_command.assert_called_with(expected_command, "Failed to create Docker container.", log_file='/path/to/log')
